...
birdStrike_df$'When: Phase of flight' <- as.factor(birdStrike_df$'Effect: Indicated Damage')
birdStrike_df$'Remains of wildlife collected' <- as.factor(birdStrike_df$'Effect: Indicated Damage')
birdStrike_df$'Remains of wildlife send to Smithsonian' <- as.factor(birdStrike_df$'Effect: Indicated Damage')
birdStrike_df$'Pilot warned of birds or wildlife' <- as.factor(birdStrike_df$'Effect: Indicated Damage')

# Precipitation table
birdStrike_df$'Conditions: Precipitation' <- as.factor(birdStrike_df$'Effect: Indicated Damage')

# Wildlife table
birdStrike_df$'Wildlife: Size' <- as.factor(birdStrike_df$'Effect: Indicated Damage')
