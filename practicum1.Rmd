...
```{r}
# Upload data
dbWriteTable(mydb, "AirlineOperator", AirlineOperatorTable, row.names = FALSE)
...
```{r}
dbWriteTable(mydb, "State", StateTable, row.names = FALSE, overwrite = TRUE)
...
```{r}
dbWriteTable(mydb, "Airport", airportTable, row.names = FALSE, overwrite = TRUE)
...
```{r}
dbWriteTable(mydb, "Aircraft", AircraftTable, row.names = FALSE, overwrite = TRUE)
...
```{r}
dbWriteTable(mydb, "Note", NoteTable, row.names = FALSE, overwite = TRUE)
...
```{r}
dbWriteTable(mydb, "Wildlife", WildlifeTable, row.names = FALSE, overwite = TRUE)
...
```{r}
dbWriteTable(mydb, "BirdStrike", BirdStrikeTable, row.names = FALSE, overwrite = TRUE)
...
```{r}
dbWriteTable(mydb, "Precipitation", PrecipTable, row.names = FALSE, overwrite = TRUE)
